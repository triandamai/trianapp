<template>
    <section class="mt-10 lg:mt-12">
        ...
        <ul role="list"
            ...
            <li class="flex"><a class="group flex items-center" aria-label="Spotify" href="/"><svg aria-hidden="true"
                    ...
                    </svg><span class="hidden sm:ml-3 sm:block">Github</span></a></li>
            ...
            <li class="flex"><a class="group flex items-center" aria-label="Overcast" href="/"><svg aria-hidden="true"
                        viewBox="0 0 32 32" class="h-8 w-8 fill-slate-400 group-hover:fill-slate-600">
                        <path
