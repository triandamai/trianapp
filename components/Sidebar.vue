<template>
    <div
                ...
                <span class="font-mono text-slate-500">Made by</span>
                ...
                <span aria-hidden="true" class="mt-6 text-slate-400">/</span>
                <nuxt-link class="cursor-pointer" to="/projects">
                        Projects
                </nuxt-link>
                <span aria-hidden="true" class="mt-6 text-slate-400">/</span>
                <nuxt-link class="cursor-pointer" to="/snippets">
                        Snippets
                </nuxt-link>
            </div>
</template>