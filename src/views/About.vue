<template>
  <section
    class="relative h-screen pt-4 overflow-hidden font-mono bg-white dark:bg-gray-800"
  >
    ...
    <header class="z-30 flex items-center w-full h-24 mt-18 sm:h-32">
      <div class="container flex items-center justify-between px-6 mx-auto">
        ...
        >
          ...
          <span class="mt-1 ml-3 text-xs"> TRIANNURIZKILLAh@MAIl.COM </span>
        </div>
      </div>
    </header>
      ...
      >
        <div class="flex flex-col">
          <img
            ...
            class="mx-auto rounded-full w-28"
          />
