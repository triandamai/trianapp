  ...
  <div>
    ...
    >
      ...
      <div style="font-family: 'Poppins', sans-serif">
        ...
        <div>
          <div
            class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col"
          >
            <!-- Left Column -->
            <div
    ...
    <section
      class="h-full pt-20 pb-12 lg:px-24 md:px-16 sm:px-8 px-4"
      style="background-color: #141432"
    >
      <footer class="h-full" style="font-family: 'Poppins', sans-serif">
        ...
        <div class="border-color-footer-2-3 mx-auto">
          ...
          >
            ...
            <nav
              class="mx-auto flex flex-wrap items-center text-base justify-center"
            >
