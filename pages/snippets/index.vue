                    ...
                    <div class="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                        <div class="flex flex-col items-start">
                            <h2 id="episode-5-title" class="mt-2 text-lg font-bold text-slate-900">
                                <nuxt-link to="/snippets/Tes-aja">Snippet pertama</nuxt-link>
                                </h2>
                            ...
                            <div class="mt-4 flex items-center gap-4">
                                <button type="button"
                                    ...
                                    <span
                                    aria-hidden="true" class="text-sm font-bold text-slate-400">/</span><a
                                    class="flex items-center text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900"
                                    aria-label="Show notes for episode 5: Bill Lumbergh" href="/5">#Tags</a></div>
                        </div>
                    </div>
                </div>
            </div>
