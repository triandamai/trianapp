...
<div class="divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <div class="container py-12">
        <div class="flex flex-wrap -m-4">
         ...
         <div
    class="items-start m-16 space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0"
  >
    ...
    <div class="pt-8 pb-8 prose dark:prose-dark max-w-none xl:col-span-2">
      <p>
        Tails Azimuth is a professor of atmospheric sciences at the Stanford AI
        Lab. His research interests includes complexity modelling of tailwinds,
        headwinds and crosswinds.
      </p>
      <p>
        He leads the clean energy group which develops 3D air pollution-climate
        models, writes differential equation solvers, and manufactures titanium
        plated air ballons. In his free time he bakes raspberry pi.
      </p>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed neque elit,
        tristique placerat feugiat ac, facilisis vitae arcu. Proin eget egestas
        augue. Praesent ut sem nec arcu pellentesque aliquet. Duis dapibus diam
